...
const AddNewShop = () => {
  ...
  const generateValidationSchema = () => {
    const shape: { [key: string]: any } = {
      ...
      hasWarehouse: Yup.string().required("وضعیت انبار الزامی است"),
      warehouseOwnershipType: Yup.string().when("hasWarehouse", {
        is: "بله",
        then: Yup.string().required("نوع مالکیت انبار الزامی است"),
      }),
      warehouseArea: Yup.string().when("hasWarehouse", {
        is: "بله",
        then: Yup.string()
          .matches(/^\d+$/, "متراژ باید عدد باشد")
        ...
        <ScrollView>
          ...
          <InputContainer title="مشخصات فروشگاه">
            ...
            <AppTextInput
              ...
              onChangeText={() => {}}
            ></AppTextInput>
            {customFieldType1.map((customField) => renderInput(customField))}
          </InputContainer>
          <InputContainer title="مشخصات فردی">
            ...
            {/* <AppTextInput
              ...
              onChangeText={() => {}}
            ></AppTextInput> */}
            {customFieldType3.map((customField) => renderInput(customField))}
          </InputContainer>
          ...
          <InputContainer title="مشخصات انبار">
            ...
            {/* <AppTextInput
              ...
              onChangeText={() => {}}
            ></AppTextInput> */}
            {customFieldType2.map((customField) => renderInput(customField))}
          </InputContainer>
